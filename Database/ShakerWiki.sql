...
CREATE TABLE IF NOT EXISTS `ShakerWiki`.`cocteil_ingredients` (
  ...
  INDEX `cocteil_idx` (`idCocteil` ASC),
...
START TRANSACTION;
USE `ShakerWiki`;
INSERT INTO `ShakerWiki`.`cocteil_ingredients` (`idCocteil`, `idIngredients`, `volum`) VALUES (1, 1, '1/2 дольки');
INSERT INTO `ShakerWiki`.`cocteil_ingredients` (`idCocteil`, `idIngredients`, `volum`) VALUES (1, 2, '30 мл');
INSERT INTO `ShakerWiki`.`cocteil_ingredients` (`idCocteil`, `idIngredients`, `volum`) VALUES (1, 3, '30 мл');
INSERT INTO `ShakerWiki`.`cocteil_ingredients` (`idCocteil`, `idIngredients`, `volum`) VALUES (1, 4, NULL);
INSERT INTO `ShakerWiki`.`cocteil_ingredients` (`idCocteil`, `idIngredients`, `volum`) VALUES (1, 5, NULL);
