...
CREATE TABLE IF NOT EXISTS `ShakerWiki`.`cocteil_ingredients` (
  `name_of_cocteil` VARCHAR(45) NOT NULL,
  `name_of_ingredient` VARCHAR(45) NOT NULL,
...
START TRANSACTION;
USE `ShakerWiki`;
INSERT INTO `ShakerWiki`.`cocteil_ingredients` (`name_of_cocteil`, `name_of_ingredient`, `volum`) VALUES ('Американо', 'Апельсин', '1/2 дольки');
INSERT INTO `ShakerWiki`.`cocteil_ingredients` (`name_of_cocteil`, `name_of_ingredient`, `volum`) VALUES ('Американо', 'Кампари', '30 мл');
INSERT INTO `ShakerWiki`.`cocteil_ingredients` (`name_of_cocteil`, `name_of_ingredient`, `volum`) VALUES ('Американо', 'Красный вермут', '30 мл');
INSERT INTO `ShakerWiki`.`cocteil_ingredients` (`name_of_cocteil`, `name_of_ingredient`, `volum`) VALUES ('Американо', 'Содовая', NULL);
INSERT INTO `ShakerWiki`.`cocteil_ingredients` (`name_of_cocteil`, `name_of_ingredient`, `volum`) VALUES ('Американо', 'Лед в кубиках', NULL);
